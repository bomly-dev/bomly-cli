...
Package managers Bomly recognizes in the `cpp` ecosystem:

| Package manager | Detector chain | Evidence patterns | Install-first support |
| --- | --- | --- | --- |
| [`conan`](conan.md) | `conan-detector`, `syft-detector` | `conan.lock`, `conanfile.txt`, `conanfile.py`, `conaninfo.txt` | No |
