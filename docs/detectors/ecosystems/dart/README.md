...
Package managers Bomly recognizes in the `dart` ecosystem:

| Package manager | Detector chain | Evidence patterns | Install-first support |
| --- | --- | --- | --- |
| [`pub`](pub.md) | `pub-native-detector`, `pub-detector`, `syft-detector` | `pubspec.lock`, `pubspec.yaml`, `pubspec.yml` | No |
