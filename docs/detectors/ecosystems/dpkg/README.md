...
Package managers Bomly recognizes in the `dpkg` ecosystem:

| Package manager | Detector chain | Evidence patterns | Install-first support |
| --- | --- | --- | --- |
| [`dpkg`](dpkg.md) | `syft-detector` | `lib/dpkg/status`, `lib/dpkg/status.d/*`, `lib/opkg/info/*.control`, `lib/opkg/status` | No |
