...
Bomly uses these detector chains when it finds `elixir` package-manager evidence.

| Package manager | Detector chain | Evidence patterns | Install-first support | Native command hints |
| --- | --- | --- | --- | --- |
| `mix` | `mix-detector`, `syft-detector` | `mix.lock`, `mix.exs` | No | `mix`, `syft for bomly-lite` |
