# Github Actions Detectors

<!-- Auto-generated by make generate. Do not edit manually. -->

Bomly uses these detector chains when it finds `github-actions` package-manager evidence.

| Package manager | Detector chain | Evidence patterns | Install-first support | Native command hints |
| --- | --- | --- | --- | --- |
| `github-actions` | `github-actions-detector`, `syft-detector` | `.github/workflows/*.yaml`, `.github/workflows/*.yml`, `.github/actions/*/action.yml`, `.github/actions/*/action.yaml` | No | `syft for bomly-lite` |
