...
Package managers Bomly recognizes in the `haskell` ecosystem:

| Package manager | Detector chain | Evidence patterns | Install-first support |
| --- | --- | --- | --- |
| [`cabal`](cabal.md) | `syft-detector` | `cabal.project.freeze` | No |
| [`stack`](stack.md) | `syft-detector` | `stack.yaml`, `stack.yaml.lock` | No |
