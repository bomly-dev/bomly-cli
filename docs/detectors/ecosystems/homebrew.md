...
Bomly uses these detector chains when it finds `homebrew` package-manager evidence.

| Package manager | Detector chain | Evidence patterns | Install-first support | Native command hints |
| --- | --- | --- | --- | --- |
| `homebrew` | `syft-detector` | `Cellar/*/*/.brew/*.rb`, `Library/Taps/*/*/Formula/*.rb` | No | `syft for bomly-lite` |
