...
| --- | --- | --- | --- | --- |
| [`gradle`](gradle.md) | `gradle-detector`, `syft-detector` | `build.gradle`, `build.gradle.kts`, `settings.gradle`, `settings.gradle.kts`, `gradle.lockfile*` | `direct-bump`, `transitive-override` | Yes |
| [`maven`](maven.md) | `maven-detector`, `syft-detector` | `pom.xml`, `*pom.xml` | `direct-bump`, `transitive-override` | Yes |
