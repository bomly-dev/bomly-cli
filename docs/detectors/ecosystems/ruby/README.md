...
Package managers Bomly recognizes in the `ruby` ecosystem:

| Package manager | Detector chain | Evidence patterns | Remediation hints | Install-first support |
| --- | --- | --- | --- | --- |
| [`bundler`](bundler.md) | `bundler-detector`, `syft-detector` | `Gemfile.lock`, `Gemfile.next.lock` | `direct-bump`, `transitive-override` | Yes |
| [`gemspec`](gemspec.md) | `syft-detector` | `*.gemspec` | None | No |
