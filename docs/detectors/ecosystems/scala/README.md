...
Package managers Bomly recognizes in the `scala` ecosystem:

| Package manager | Detector chain | Evidence patterns | Install-first support |
| --- | --- | --- | --- |
| [`sbt`](sbt.md) | `sbt-native-detector`, `sbt-detector` | `build.sbt`, `project/plugins.sbt`, `project/build.properties` | No |
