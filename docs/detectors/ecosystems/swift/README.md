...
| --- | --- | --- | --- | --- |
| [`cocoapods`](cocoapods.md) | `cocoapods-detector`, `syft-detector` | `Podfile.lock`, `Podfile` | None | No |
| [`swiftpm`](swiftpm.md) | `swiftpm-native-detector`, `swiftpm-detector`, `syft-detector` | `Package.resolved`, `.package.resolved`, `Package.swift`, `project.xcworkspace/xcshareddata/swiftpm/Package.resolved` | None | No |
