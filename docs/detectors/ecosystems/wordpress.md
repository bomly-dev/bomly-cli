...
Bomly uses these detector chains when it finds `wordpress` package-manager evidence.

| Package manager | Detector chain | Evidence patterns | Install-first support | Native command hints |
| --- | --- | --- | --- | --- |
| `wordpress` | `syft-detector` | `wp-content/plugins/*/*.php` | No | `syft for bomly-lite` |
