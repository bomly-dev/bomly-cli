...
func newDiffCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resolutionWarnings = append(resolutionWarnings, diffResult.Base.ResolutionWarnings...)
			resolutionWarnings = append(resolutionWarnings, diffResult.Head.ResolutionWarnings...)
