...
func RegistryConfigsFromResolved(cfg config.Resolved) engine.RegistryConfigs {
	...
	deniedSourceChanges, _ := sdk.ParseDependencySourceChangePolicies(cfg.DenyDependencySourceChanges)
	return engine.RegistryConfigs{
		...
		DenyDependencySourceChanges: append([]sdk.DependencySource(nil), deniedSourceChanges...),
