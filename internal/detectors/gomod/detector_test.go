...
`)
	...
	if got := uuidNode.Scope; got != string(detectors.ScopeRuntime) {
	...
	if got := textNode.Scope; got != string(detectors.ScopeRuntime) {
	...
	if got := testifyNode.Scope; got != string(detectors.ScopeDevelopment) {
	...
	if got := spewNode.Scope; got != string(detectors.ScopeDevelopment) {
