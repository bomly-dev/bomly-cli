...
func (c *embeddedHostContext) HTTPClient() *httpkit.ClientProvider {
...
func (c *embeddedHostContext) Runtime() plugin.RuntimeInfo {
	info := plugin.RuntimeInfo{Execution: plugin.ExecutionEmbedded}
	if c != nil && c.registry != nil {
...
func (r *Registry) RegisterModule(m plugin.Module, opts ComponentOptions) error {
	if r == nil {
