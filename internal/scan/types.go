...
type FindingKind = model.FindingKind

const (
	FindingKindRisk          = model.FindingKindRisk
	FindingKindVulnerability = model.FindingKindVulnerability
	FindingKindPolicy        = model.FindingKindPolicy
)
