...
If a missing prefix produces a false-negative for a direct import, add the mapping to `prefixmap.go` in the `bomly-plugin-jvmreach-analyzer` repository (one-line PR).
