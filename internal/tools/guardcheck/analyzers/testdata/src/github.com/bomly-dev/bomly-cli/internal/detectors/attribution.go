...
func Attributed(result plugin.DetectionResult, declarations ...any) plugin.DetectionResult {
	return result
}

// Unattributed returns the result unchanged, with the reason there is no root.
func Unattributed(result plugin.DetectionResult, reason string) plugin.DetectionResult { return result }
